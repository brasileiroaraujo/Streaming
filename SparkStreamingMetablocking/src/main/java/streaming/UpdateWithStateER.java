...
import streaming.util.StreamingEntity;
...
public class UpdateWithStateER {
  public static void main(String[] args) {
    ...
    JavaDStream<StreamingEntity> streamOfItems = streamOfRecords.map(s -> new StreamingEntity(s));
    

    JavaPairDStream<String, StreamingEntity> streamOfPairs =
        streamOfItems.flatMapToPair(new PairFlatMapFunction<StreamingEntity, String, StreamingEntity>() {
			@Override
			public Iterator<Tuple2<String, StreamingEntity>> call(StreamingEntity se) throws Exception {
				Set<Tuple2<String, StreamingEntity>> output = new HashSet<Tuple2<String, StreamingEntity>>();
				
				String[] tokens = se.getCategory().split(" ");
    ...
    JavaPairDStream<String, Iterable<StreamingEntity>> streamGrouped = streamOfPairs.groupByKey();
...
//    });
    ...
    JavaPairDStream<String, String> pairEntityBlock = streamGrouped.flatMapToPair(new PairFlatMapFunction<Tuple2<String,Iterable<StreamingEntity>>, String, String>() {

		@Override
		public Iterator<Tuple2<String, String>> call(Tuple2<String, Iterable<StreamingEntity>> input) throws Exception {
			Set<Tuple2<String, String>> output = new HashSet<Tuple2<String, String>>();
			
			for (StreamingEntity streamingEntity : input._2()) {
				Tuple2<String, String> pair = new Tuple2<String, String>(streamingEntity.getValue()+"", input._1());
				output.add(pair);
			}
...
//    finalOutputProcessed.cache().foreachRDD(rdd -> {
//        System.out.println("Batch size: " + rdd.count());
//        rdd.foreach(e -> System.out.println(e));
//      });
    ...
    JavaPairDStream<String, String> similarities = finalOutputProcessed.flatMapToPair(new PairFlatMapFunction<Tuple2<String,List<List<String>>>, String, String>() {
